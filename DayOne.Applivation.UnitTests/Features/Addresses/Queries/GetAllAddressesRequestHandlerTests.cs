...
namespace DayOne.Applivation.UnitTests.Features.Addresses.Queries
{
    ...
    {
        [Fact]
        public async Task GetAllAddressesQueryHandler_ListOfAddresses_ReturnsResultDataWithListOfAddresses()
        {
            //Arrange
            ...
            static Mock<IAddressRepo> GetAddressRepository()
            {
                ...
                mockAddressRepository.Setup(r => r.GetAllAddresses()).ReturnsAsync(addreses);
        ...
        [Fact]
        public async Task GetAllAddressesQueryHandler_EmptyAddresses_ReturnsResultDataWithNull()
        {
            //Arrange
            Mock<IAddressRepo> mockAddressRepository = GetAddressRepository();
            ...
            static Mock<IAddressRepo> GetAddressRepository()
            {
                ...
                mockAddressRepository.Setup(r => r.GetAllAddresses()).ReturnsAsync(new List<AddressResponse>());
        ...
        [Fact]
        public async Task GetAllAddressesQueryHandler_ListOfAddresses_ReturnsCorrectCountOfAddresses()
        {
            //Arrange
            Mock<IAddressRepo> mockAddressRepository = GetAddressRepository();
        ...
        [Fact]
        public async Task GetAllAddressesQueryHandler_EmptyAddresses_ReturnsResultNoAddressFoundMessage() 
        {
            //Arrange
            Mock<IAddressRepo> mockAddressRepository = GetAddressRepository();
        ...
        {
            //Arrange
            Mock<IAddressRepository> mockAddressRepository = GetAddressRepository();
            ...
            result.ShouldBeOfType<Result<List<AddressResponse>>>();
            #region Core Setup
            static Mock<IAddressRepository> GetAddressRepository()
            {
                var addreses = new List<AddressResponse>
                {
                    new AddressResponse{ Id= 1, Email = "Junior1@gmail.com", CellphoneNo = "029292",Street="277 Bulang", Suburb ="Mamelodi East", City = "Pretoria", PostCode ="0122"},
